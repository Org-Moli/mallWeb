 ...
 <style type="text/css">
  ...
  <script>
		...
		function xzfh2(){
			...
			//document.body.style.transform = 'rotate('+current+'deg)';
			$('#loginbox').css('transform','rotate('+current+'deg)');
			current ++;
...
<body>
	<div class="head">
<!-- 	<img src="static/login/images/qanpai.png" style="padding-left: 10%">
 -->	</div>
	<div style="width:100%;height:88% ;text-align: center;margin: 0 auto;position: absolute;background: url(static/login/images/banner_1.jpg)">
		<div id="loginbox">
	...
	<div class="foot">
	<!-- Copyright © 2017 <a href="http://www.qanpai.com">www.qanpai.com</a> All Rights Reserved　版权所有 千派网络 -->
	Copyright © 2017  All Rights Reserved　安e购商城
	</div>
