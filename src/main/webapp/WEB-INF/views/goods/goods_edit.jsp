...
<body class="no-skin">
						...
						<div class="col-xs-12">
							...
							<form action="goods/${msg}.do" name="Form" id="Form"
								...
								<input type="hidden" name="goods_id" id="goods_id"
									value="${pd.goods_id}" /> <input type="hidden"
									name="goods_pic" id="filepath" />
								<div class="col-md-12">
									...
									<div class="form-group">
										...
										<div class="col-sm-9" style="width: 55%;">
											<label class="ace-file-input"> <input type="file"
												id="file" name="file" onchange="upload()"> <span
												class="ace-file-container" data-title="选择"> <span
													class="ace-file-name" data-title="请选择文件 ..."><i
										...
										<div class="col-sm-9" style="width: 55%;" id="img">
											<c:if test="${!empty pd.goods_pic}">
												<c:forEach items="${fn:split(pd.goods_pic,',')}" var="pic"
													varStatus="index">
													<img alt="" src="${pic}" width='100' id="${index.index}"
	...
	function generate(){
		var attrdiv = $('.attrdiv');//find('.form-group').find('input[name=attribute_name]');
		$('#detail_type').val(1);
		var att_th = "" ;
		var att_td = "" ;
		var thead_th ="" ;
