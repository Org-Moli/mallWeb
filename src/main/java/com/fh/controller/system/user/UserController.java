...
public class UserController extends BaseController {
	...
	public ModelAndView listUsers(Page page)throws Exception{
		...
		pd.put("ROLE_ID", "1");
		List<Role> systemRoles = roleService.listAllRolesByPId(pd);//列出所有系统用户角色
		pd.put("ROLE_ID", "3");
                List<Role> kehuRoles = roleService.listAllRolesByPId(pd);//列出所有系统用户角色
                roleList.addAll(kehuRoles);
                roleList.addAll(systemRoles);
	...
	public ModelAndView goEditU() throws Exception{
		...
		List<Role> roleList = new ArrayList();
                ...
                List<Role> kehuRoles = roleService.listAllRolesByPId(pd);//列出所有系统用户角色
                roleList.addAll(kehuRoles);
                roleList.addAll(systemRoles);	//列出所有系统用户角色
